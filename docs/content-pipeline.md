...
The birds are authored as Markdown. The game reads a generated JSON graph.
Both are committed, and keeping them in agreement is a gate.

::: danger Never hand-edit `src/aves/index.json`
...
## Adding or changing a bird

1. Add or edit the file under `src/aves/species/`.
...
surfacing it. See
[`tasks/20260729-092352/DECISION.md`](https://github.com/thlumyn/metaaves/blob/master/tasks/20260729-092352/DECISION.md),
choice 2.

The rule is expressed twice, on purpose:

- `COLLECTION_REPR` in
  [`scripts/markdown_to_json.py`](https://github.com/thlumyn/metaaves/blob/master/scripts/markdown_to_json.py)
- `isSerializedCollection` in
  [`src/frontMatter.ts`](https://github.com/thlumyn/metaaves/blob/master/src/frontMatter.ts)
...
[`tasks/20260730-120401/DECISION.md`](https://github.com/thlumyn/metaaves/blob/master/tasks/20260730-120401/DECISION.md).
...
Related history:
[`tasks/20260729-092352/`](https://github.com/thlumyn/metaaves/tree/master/tasks/20260729-092352).
