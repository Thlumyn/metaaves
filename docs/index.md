...
[Play the daily puzzle](https://thlumyn.github.io/metaaves) - or read on.
...
- The in-game [FAQ](https://thlumyn.github.io/metaaves/faq/) remains the
  player-facing short answer. These pages are the longer one.
- [`CHANGELOG.md`](https://github.com/thlumyn/metaaves/blob/master/CHANGELOG.md)
...
[`README.md`](https://github.com/thlumyn/metaaves/blob/master/README.md)
