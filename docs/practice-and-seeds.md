...
The practice page deals a random bird as often as you like. It is kept
...
Page wiring is
[`src/practice.ts`](https://github.com/thlumyn/metaaves/blob/master/src/practice.ts);
the whole round lifecycle underneath it is
[`src/practiceSession.ts`](https://github.com/thlumyn/metaaves/blob/master/src/practiceSession.ts),
...
[`e2e/seed.spec.ts`](https://github.com/thlumyn/metaaves/blob/master/e2e/seed.spec.ts).
...
`?seed=100042` would share one storage key while naming different birds.
...
[`tasks/20260729-101754/DECISION.md`](https://github.com/thlumyn/metaaves/blob/master/tasks/20260729-101754/DECISION.md)
section 4.
...
[`tasks/20260729-101754/DECISION.md`](https://github.com/thlumyn/metaaves/blob/master/tasks/20260729-101754/DECISION.md)
and
[`tasks/20260729-101819/DECISION.md`](https://github.com/thlumyn/metaaves/blob/master/tasks/20260729-101819/DECISION.md).
