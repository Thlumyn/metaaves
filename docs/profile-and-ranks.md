...
[`src/profile/index.ts`](https://github.com/thlumyn/metaaves/blob/master/src/profile/index.ts)
is the bootstrap;
[`src/profile/statsPanel.ts`](https://github.com/thlumyn/metaaves/blob/master/src/profile/statsPanel.ts)
renders it.
...
[`src/rollingAverage.ts`](https://github.com/thlumyn/metaaves/blob/master/src/rollingAverage.ts)
...
7-point window;
[`src/profile/rollingAverageChart.ts`](https://github.com/thlumyn/metaaves/blob/master/src/profile/rollingAverageChart.ts)
draws it.
...
[`src/rankLadder.ts`](https://github.com/thlumyn/metaaves/blob/master/src/rankLadder.ts)
and rendered by
[`src/ui/ladderCard.ts`](https://github.com/thlumyn/metaaves/blob/master/src/ui/ladderCard.ts).
...
- It **stops at the deepest revealed clade**. No unrevealed rung, no `???` row,
  ...
  [`tasks/20260729-182320/DECISION.md`](https://github.com/thlumyn/metaaves/blob/master/tasks/20260729-182320/DECISION.md).
