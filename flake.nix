  ...
  in
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {
        ...
        # virtualenv = pythonSet.mkVirtualEnv "metaaves-dev-env" workspace.deps.all;
        # Uv2nix supports editable packages, but requires you to generate a separate overlay & package set for them:
        editablePythonSet = pythonSet.overrideScope editableOverlay;
        virtualenv = editablePythonSet.mkVirtualEnv "metaaves-dev-env" workspace.deps.all;
      ...
      in {
        ...
        packages.default = mkApplication {
          venv = pythonSet.mkVirtualEnv "metaaves-env" workspace.deps.default;
          package = pythonSet.metaaves;
        };

        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/metaaves";
        };
